...
<script src="${mainpath}/js/addBeacon.js"></script>
					...
					<dl class="dl-horizontal">
						...
						<dd>
							<input id="building" type="text" placeholder="请输入楼编号"
								class="input-xlarge" value="${buildingId}">
						</dd>
						<br />
						<dt>
						...
						<dd>
							<input id="x" type="text" placeholder="请输入设备X坐标"
								class="input-xlarge"> <label class="control-label">y坐标</label>
							<input id="y" type="text" placeholder="请输入设备Y坐标"
								class="input-xlarge"> <input type="button" class="btn"
								value="点击在地图上定位"
								onclick="loadLocatedMap('#building','#floor','canvas');" /> <br />
							<div
