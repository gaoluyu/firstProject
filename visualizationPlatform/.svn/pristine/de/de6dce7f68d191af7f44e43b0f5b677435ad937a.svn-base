...
public class HttpUtil {
	...
	public static Map<String, Object> post(String url, Map<String, String> params) {
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				...
				result = new String(EntityUtils.toString(response.getEntity()).getBytes("UTF-8"), "UTF-8");// ISO_8859_1
			}
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	 ...
	 */
	public static Map<String, Object> getResponseJsonMap(String url, Map<String, Object> params, String[] retKey) {
	 ...
	 * @return 文件名
	 */
	public static String getResponseFile(String url, String params, String saveParentPath, boolean unique) {
